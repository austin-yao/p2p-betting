const Home = () => {
    return (
        <div className="min-h-screen flex flex-col items-center">
            ...
            from-slate-600 via-sky-100 to-slate-600
            animate-text pb-5
            ">
                    Welcome to Peer-to-Peer Betting on SUI
                </h1>
                <p className="mt-4 text-lg sm:text-xl font-semibold opacity-60">
                    Bet with anyone, on anything.
                </p>
            </header>

            {/* Instructions Section */}
            <section className="text-center mx-9 px-9 py-8 bg-gray-50 dark:bg-slate-700 shadow-md rounded-lg max-w-3xl">
                <h2 className="text-2xl font-bold mb-4 text-slate-700 dark:text-sky-100">
                    How It Works
                </h2>
                <ul className="text-left text-lg space-y-3 leading-relaxed">
